...
final class TSOLIIN_Link_Inspector {
	...
	public function maybe_upgrade_db() {
		...
		if ( version_compare( $installed, TSOLIIN_VERSION, '<' ) ) {
			...
			delete_option( TSOLIIN_DB::SCHEMA_OK_OPTION );
			delete_transient( 'tsoliin_legacy_pc_checked' );
	...
	private function ensure_progress_options_not_autoloaded() {
		$keys = array(
			...
			TSOLIIN_Cron::OPT_SCAN_REST_UNTIL,
			TSOLIIN_Cron::OPT_CHECK_REST_UNTIL,
			TSOLIIN_Cron::OPT_SCAN_PAGE_POS,
			TSOLIIN_Cron::OPT_PHASE_CEILING,
			TSOLIIN_Cron::OPT_SKIPPED,
			TSOLIIN_Cron::OPT_RESYNCED,
			TSOLIIN_Cron::OPT_INFLIGHT_PREFIX . 'scan_post',
			TSOLIIN_Cron::OPT_INFLIGHT_PREFIX . 'scan_phase',
			TSOLIIN_Cron::OPT_INFLIGHT_PREFIX . 'check_link',
